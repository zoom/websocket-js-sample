...
const requiredEnvVars = ['SUBSCRIPTION_ID', 'WS_URL_DEV', 'CLIENT_USERNAME', 'CLIENT_PASSWORD', 'OAUTH_URL_DEV'];
...
async function getAccessToken() {
    ...
    const url = `${process.env.OAUTH_URL_DEV}?grant_type=client_credentials`; // OAuth token URL
...
async function connectWebSocket() {
    ...
    const primaryWsUrl = `${process.env.WS_URL_DEV}?subscriptionId=${subscriptionId}`;
    let socket;
